...
1$:
        ...
        VM_IF_CONST             .EQ, VAR_S6A6_PLAYER_HEALTH, 4, 2$, 0
        ; If Variable .EQ Value
        VM_IF_CONST             .EQ, VAR_S6A6_PLAYER_HEALTH, 3, 4$, 0
        VM_JUMP                 5$
4$:
        ; Actor Set Active
...
5$:
        ...
        ; If Variable .EQ Value
        VM_IF_CONST             .EQ, VAR_S6A6_PLAYER_HEALTH, 2, 6$, 0
        VM_JUMP                 7$
6$:
        ; Actor Set Active
        VM_SET_CONST            .LOCAL_ACTOR, 2
...
7$:
        ...
        ; If Variable .EQ Value
        VM_IF_CONST             .EQ, VAR_S6A6_PLAYER_HEALTH, 1, 8$, 0
        VM_JUMP                 9$
8$:
        ; Actor Set Active
        VM_SET_CONST            .LOCAL_ACTOR, 2
...
9$:
        ...
        ; If Variable .EQ Value
        VM_IF_CONST             .EQ, VAR_S6A6_PLAYER_HEALTH, 0, 10$, 0
        VM_JUMP                 11$
10$:
        ; Actor Set Active
        VM_SET_CONST            .LOCAL_ACTOR, 2
